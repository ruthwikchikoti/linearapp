...
function HomeContent() {
  ...
  const [activeView, setActiveView] = useState<"all" | "my-issues" | "inbox">("all");
        ...
        <div className="nav-bar">
          ...
          <div className="issue-search">
            ...
            <div className="feature">
              ...
              <div onClick={() => {
                setActiveView('all');
                setFilters({ ...filters, assignee: '' }); // Clear assignee filter
              }} className={activeView === 'all' && router.pathname === '/app' ? 'active' : ''}>
                <ViewIcon />
                All Issues
              </div>
              <div>
            ...
            {hasNoIssues ? (
              <div className="empty-state-container">
                ...
                <h3 className="empty-state-title">
                  {isMyIssuesView ? 'No issues assigned to you' : 'No issues yet'}
                </h3>
